...
var AULeafletCustomElement = (function () {
    ...
    AULeafletCustomElement.prototype.withLayerControlChanged = function (newValue) {
        ...
        if (newValue === false) {
            ...
            this._mapInit.then(function () {
                ...
                _this.layerControl = createLayersControl(_this.attachedLayers.base, _this.attachedLayers.overlay, newValue).addTo(_this.map);
            });
        }
    };
    AULeafletCustomElement.prototype.withScaleControlChanged = function (newValue) {
        ...
        if (newValue === false) {
            ...
            this._mapInit.then(function () {
                ...
                _this.scaleControl = createScaleControl(newValue).addTo(_this.map);
            });
        }
    };
    AULeafletCustomElement.prototype.attached = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (!_this.map) {
                _this.map = new Map(_this.mapContainer, _this.mapOptions);
            }
